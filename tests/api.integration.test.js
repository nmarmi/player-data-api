...
beforeAll(() => {
  ...
  const insertPlayer = db.prepare(`
    INSERT OR IGNORE INTO players (player_id, mlb_person_id, name, player_name, positions, mlb_team, mlb_team_id, mlb_team_id, status)
    VALUES (@player_id, @mlb_person_id, @name, @name, @positions, @mlb_team, @mlb_team_id, @mlb_team_id, 'active')
  `);
  ...
  const testData = [
    { player_id: 'mlb-901001', mlb_person_id: 901001, name: 'Test Hitter 1', positions: '["OF"]', mlb_team: 'NYY', mlb_team_id: 'mlb-147', stat_group: 'hitting', ab: 550, r: 90, h: 165, hr: 30, rbi: 95, bb: 75, k: 120, sb: 15, avg: 0.3, obp: 0.38, slg: 0.52, ip: 0, w: 0, era: 0, whip: 0, sv: 0 },
    { player_id: 'mlb-901002', mlb_person_id: 901002, name: 'Test Hitter 2', positions: '["1B"]', mlb_team: 'LAD', mlb_team_id: 'mlb-119', stat_group: 'hitting', ab: 520, r: 80, h: 150, hr: 25, rbi: 85, bb: 65, k: 130, sb: 5, avg: 0.288, obp: 0.36, slg: 0.49, ip: 0, w: 0, era: 0, whip: 0, sv: 0 },
    { player_id: 'mlb-901003', mlb_person_id: 901003, name: 'Test Hitter 3', positions: '["3B"]', mlb_team: 'ATL', mlb_team_id: 'mlb-144', stat_group: 'hitting', ab: 500, r: 75, h: 140, hr: 22, rbi: 78, bb: 55, k: 115, sb: 8, avg: 0.28, obp: 0.35, slg: 0.47, ip: 0, w: 0, era: 0, whip: 0, sv: 0 },
    { player_id: 'mlb-901004', mlb_person_id: 901004, name: 'Test Pitcher 1', positions: '["SP"]', mlb_team: 'HOU', mlb_team_id: 'mlb-117', stat_group: 'pitching', ab: 0, r: 0, h: 0, hr: 0, rbi: 0, bb: 0, k: 200, sb: 0, avg: 0, obp: 0, slg: 0, ip: 180, w: 15, era: 3.2, whip: 1.1, sv: 0 },
    { player_id: 'mlb-901005', mlb_person_id: 901005, name: 'Test Closer 1', positions: '["RP"]', mlb_team: 'BOS', mlb_team_id: 'mlb-111', stat_group: 'pitching', ab: 0, r: 0, h: 0, hr: 0, rbi: 0, bb: 0, k: 80, sb: 0, avg: 0, obp: 0, slg: 0, ip: 65, w: 4, era: 2.8, whip: 1.05, sv: 35 },
  ];
  db.transaction(() => {
...
describe('US-7.4 integration tests for API endpoints', () => {
  ...
  test('US-7.5: sequential draft-state transitions update valuations and recommendations', async () => {
    ...
    expect(initialVals.body.valuations.length).toBeGreaterThan(4);
